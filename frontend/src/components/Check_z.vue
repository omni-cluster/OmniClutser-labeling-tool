    ...
    <el-col :xs="15" :sm="16" :md="17" :lg="18" :xl="19">
      <div class="chart-container bg-purple-dark" v-if="flag">
        <el-scrollbar style="height:100%; width:100%">
          <dygraph :graphData="paintData" :oldLabel="oldLabel" :isCompare="isCompare" :dimension="dimension" id="templateDygraphs" :dataName="paintDataName">
          </dygraph>
        </el-scrollbar>
      </div>
    </el-col>
      ...
      await axios.post(
        ...
        .then(res => {
          if (res.data !== 'failed') {
            ...
            this.dimension = this.paintData[0].length
            this.flag = true
          } else {
